...
export default function ComprasPage() {
  ...
  const loadTransactions = useCallback(async () => {
    ...
    const { data, count } = await getTransactionsPaginated('entrada', currentPage, itemsPerPage, filters)
  ...
  const handleSubmit = async (e: React.FormEvent) => {
    ...
    if (result.error) {
      ...
      toast.success(editingTransaction ? 'Compra atualizada!' : 'Compra registrada!')
    ...
    <div className="space-y-6">
      ...
      <div className="flex items-center justify-between">
        <div>
          ...
          <p className="text-muted-foreground">Gerencie todas as compras registradas</p>
        </div>
        ...
        <CardHeader>
          <div className="flex items-center justify-between">
            <div>
              ...
              <CardDescription>Filtre as compras por fornecedor e período</CardDescription>
            </div>
      ...
      <Card>
        <CardHeader>
          ...
          <CardDescription>
            Total: {totalCount} compra(s) | Página {currentPage} de {totalPages || 1}
          </CardDescription>
        </CardHeader>
        <CardContent>
      ...
      <Dialog open={formOpen} onOpenChange={handleFormClose}>
        <DialogContent className="sm:max-w-[600px]">
          <DialogHeader>
            <DialogTitle>{editingTransaction ? 'Editar' : 'Nova'} Compra</DialogTitle>
          ...
          <form onSubmit={handleSubmit}>
            <div className="space-y-4 py-4">
              <div className="grid gap-4 md:grid-cols-2">
                ...
                <div className="space-y-2">
                  <Label htmlFor="client">Fornecedor *</Label>
                  <Select
